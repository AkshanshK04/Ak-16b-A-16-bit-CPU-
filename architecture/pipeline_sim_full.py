...
def sign_extend_4bit(val):
    ...
    return val & 0xF  # Just mask to 4 bits, no sign extension
...
def forward_val(rs):
    ...
    # Priority 1: Forward from EX2 stage (ALU result only, NOT load)
    ...
    # Priority 2: Forward from MEM stage (including load data)
